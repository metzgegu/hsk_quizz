...
export default function Parameter({ onSubmit }: Props): JSX.Element {
  ...
  return (
    <form className="text-center" onSubmit={handleSubmit}>
      <h4 className="mt-0">Preferences</h4>
      ...
      <div className="mb-4">
        ...
        />
        <label className="pl-2" htmlFor="pinyin">
          Display pinyin
        </label>
      </div>
      ...
      <div className="mb-4">
        ...
        />
        <label className="pl-2" htmlFor="numberOfProposal">
          Number of proposal
        </label>
      </div>
      ...
      <div
        className={`mb-4 flex justify-between items-center ${
          questionType === QuestionTypes.TRANSLATIONS_TO_HANZI ? 'flex-row-reverse' : ''
        }`}
      >
        <div>Chinese</div>
        <div>
